<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="AgentRegistration.aspx.cs" Inherits="AgentRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="pc">
        ...
        <div class="page-header">
            <div class="ph-left">
                <div class="ph-title">Add Sub-Agent</div>
                <div class="ph-sub">Register a new agent under your team</div>
            </div>
            <div class="ph-actions">
                <a href="agent_myagents.aspx" class="btn btn-outline btn-sm">← Back to My Agents</a>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    <div class="card-title">Agent Registration Form</div>
