...
.prop-price-note { font-size: 12px; color: var(--green); font-weight: 600; }
.prop-actions { display: flex; gap: 10px; flex-wrap: wrap; }
.btn-inquire { padding: 12px 28px; background: linear-gradient(135deg,var(--gold),#C97A10); border-radius: 10px; font-size: 14px; font-weight: 700; color: #fff; text-decoration: none; box-shadow: 0 4px 16px rgba(232,160,32,.4); transition: all .2s; display: flex; align-items: center; gap: 7px; }
.btn-inquire:hover { transform: translateY(-1px); }
.btn-share { padding: 11px 18px; border: 1.5px solid var(--border); border-radius: 10px; background: #fff; font-size: 13px; font-weight: 600; color: var(--navy); cursor: pointer; transition: all .2s; display: flex; align-items: center; gap: 6px; font-family: 'Outfit', sans-serif; }
.btn-share:hover { border-color: var(--navy); }
.btn-wish { padding: 11px 18px; border: 1.5px solid var(--border); border-radius: 10px; background: #fff; font-size: 14px; cursor: pointer; transition: all .2s; font-family: 'Outfit', sans-serif; }
.btn-wish:hover { border-color: var(--red); }
.btn-wish.active { background: #FEF2F2; border-color: var(--red); }
...
.gallery-img { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 64px; transition: transform .4s; }
.gallery-main .gallery-img { font-size: 96px; }
.gallery-main:hover .gallery-img, .gallery-thumb:hover .gallery-img { transform: scale(1.06); }
...
.contact-card { background: var(--white); border: 1px solid var(--border); border-radius: var(--r); padding: 28px; box-shadow: var(--shadow); }
.cc-title { font-family: 'Cormorant Garamond', serif; font-size: 20px; font-weight: 700; color: var(--navy); margin-bottom: 20px; }
.cc-agent { display: flex; align-items: center; gap: 12px; margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid var(--border); }
.agent-avatar { width: 52px; height: 52px; border-radius: 50%; background: linear-gradient(135deg,var(--navy),var(--ocean)); display: flex; align-items: center; justify-content: center; font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 700; color: var(--gold); flex-shrink: 0; }
.agent-name { font-size: 15px; font-weight: 700; color: var(--navy); }
.agent-role { font-size: 12px; color: var(--slate); }
.agent-rating { display: flex; align-items: center; gap: 4px; font-size: 12px; color: var(--gold); margin-top: 3px; }
.cc-form { display: flex; flex-direction: column; gap: 12px; }
.cc-input { width: 100%; padding: 11px 14px; border: 1.5px solid var(--border); border-radius: 9px; font-size: 13.5px; color: var(--navy); background: var(--mist); outline: none; transition: border-color .2s; font-family: 'Outfit', sans-serif; }
.cc-input:focus { border-color: var(--ocean); background: #fff; }
.cc-input::placeholder { color: #A0AEC0; }
.cc-textarea { resize: vertical; min-height: 90px; }
.btn-contact-full { width: 100%; padding: 13px; background: linear-gradient(135deg,var(--gold),#C97A10); border: none; border-radius: 10px; color: #fff; font-size: 14.5px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 16px rgba(232,160,32,.4); transition: all .2s; font-family: 'Outfit', sans-serif; display: flex; align-items: center; justify-content: center; gap: 7px; }
.btn-contact-full:hover { transform: translateY(-1px); }
.btn-call { width: 100%; padding: 12px; border: 1.5px solid var(--navy); border-radius: 10px; background: transparent; color: var(--navy); font-size: 14px; font-weight: 700; cursor: pointer; transition: all .2s; font-family: 'Outfit', sans-serif; display: flex; align-items: center; justify-content: center; gap: 7px; margin-top: 8px; }
...
.lb-img { width: 100%; height: 520px; border-radius: var(--r); overflow: hidden; }
.lb-img img { width: 100%; height: 100%; object-fit: cover; }
.lb-img-placeholder { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 120px; }
...
.lb-nav { display: flex; justify-content: center; gap: 12px; margin-top: 18px; }
.lb-dot { width: 8px; height: 8px; border-radius: 50%; background: rgba(255,255,255,.3); cursor: pointer; transition: background .2s; }
...
@media (max-width: 768px) {
  ...
  .btn-inquire { flex: 1; justify-content: center; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="breadcrumb-wrap">
        <div class="breadcrumb">
            <a href="property-search.aspx">🏠 Home</a>
        ...
        <div class="gallery-inner">
            ...
            <div class="prop-title-row">
                <div class="prop-title-left">
                    ...
                    <div class="prop-location">📍
                        <span><asp:Literal ID="litLocation" runat="server" /> —
            ...
            <div class="gallery-grid">
                <div class="gallery-main" onclick="openLightbox(0)">
                    ...
                    <div class="gallery-count">📷 <asp:Literal ID="litPhotoCount" runat="server" Text="View All Photos" /></div>
                </div>
        ...
        <div class="detail-layout">
                ...
                <div class="tab-pane" id="tab-details">
                    <div class="detail-section fade-in">
                        ...
                        <div class="details-grid">
                            ...
                            <div class="dg-item"><div class="dg-lbl">Possession</div><div class="dg-val"><asp:Literal ID="litPossession" runat="server" /></div></div>
                            ...
                            <div class="dg-item"><div class="dg-lbl">Approval</div><div class="dg-val"><asp:Literal ID="litApproval" runat="server" /></div></div>
                            <div class="dg-item"><div class="dg-lbl">Road Width</div><div class="dg-val"><asp:Literal ID="litRoadWidth" runat="server" /></div></div>
                            <div class="dg-item"><div class="dg-lbl">Registry</div><div class="dg-val"><asp:Literal ID="litRegistry" runat="server" /></div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="tab-payment">
                    <div class="detail-section fade-in">
                        ...
                        <asp:Repeater ID="rptPayment" runat="server"
                            OnItemDataBound="rptPayment_ItemDataBound">
                            <HeaderTemplate>
                        ...
                        <asp:Panel ID="pnlNoPayment" runat="server" Visible="false">
                            <div class="no-payment">
                                💳 Payment plan details coming soon. Please contact our agent for pricing.
                            </div>
                        </asp:Panel>

                        <p style="font-size:12px;color:var(--slate);margin-top:14px;line-height:1.6;">
                            * Prices are subject to change. Possession charges & development charges may apply.
                            Contact our agent for current pricing and availability.
                        </p>
                    </div>
                </div>
            ...
            <div class="detail-right" id="contact-form">
                ...
                <div class="contact-card fade-in">
                    ...
                    <div class="cc-form">
                        <input class="cc-input" type="text" id="inquiryName" placeholder="Your Full Name" />
                        <input class="cc-input" type="email" id="inquiryEmail" placeholder="Email Address" />
                        <input class="cc-input" type="tel" id="inquiryPhone" placeholder="Phone Number" />
                        <textarea class="cc-input cc-textarea" id="inquiryMsg">I'm interested in <asp:Literal ID="litInquiryDefault" runat="server" />. Please send me more details about available plots and payment plans.</textarea>
                        <button class="btn-contact-full" onclick="submitInquiry()">📩 Send Inquiry</button>
                        <button class="btn-call" onclick="window.location.href='tel:+913001234567'">📞 Call: +91 300 1234567</button>
                    </div>
                </div>
    ...
    <div class="lightbox" id="lightbox" onclick="closeLightboxOuter(event)">
        <div class="lb-inner">
            ...
            <div class="lb-img" id="lbContent">
                <asp:Literal ID="litLightboxMain" runat="server" />
            </div>
            <div class="lb-nav">
    ...
    <script>
        ...
        function submitInquiry() {
            ...
            alert('✅ Inquiry sent! Our agent will contact you within 24 hours.');
        }

        // Lightbox
        var lbImages = [
            { type: 'elem', id: 'lbContent' },  // slot 0 = cover image (already rendered)
            { type: 'placeholder', bg: 'linear-gradient(135deg,#1756A9,#3B90F5)', icon: '🌳' },
            { type: 'placeholder', bg: 'linear-gradient(135deg,#0F766E,#14B8A6)', icon: '🏊' }
        ];
        var coverHtml = document.getElementById('lbContent') ? document.getElementById('lbContent').innerHTML : '';
        var currentLb = 0;
        ...
        function updateLb() {
            ...
            if (currentLb === 0) {
                ...
                var img = lbImages[currentLb];
                box.innerHTML = "<div class='lb-img-placeholder' style='background:" + img.bg + "'>" + img.icon + "</div>";
            }
            document.querySelectorAll('.lb-dot').forEach(function(d, i){
                d.classList.toggle('active', i === currentLb);
            });
        }
