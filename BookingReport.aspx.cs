...
public partial class BookingReport : System.Web.UI.Page
{
    ...
    {
        this.BtnBooking.Attributes.Add("onclick", DisableTheButton(this.Page, this.BtnBooking));
        if (!Page.IsPostBack)
        {
    ...
    private void BindCustomers()
    {
        try
        {
            query = ObjDal.Isostart + "exec sp_getBookingReport '" + Session["idno"] + "'" + ObjDal.IsoEnd;
            ...
            lblTotalConfirmed.Text = totalRecords.ToString();
           // lblTotalAll.Text = totalRecords.ToString();
            // ── Pagination labels ──
